	...
	const guideSteps = [
		{
			...
			titleKey: 'customer.steps.step1.title',
			descriptionKey: 'customer.steps.step1.description',
		},
		{
			image: '/customer_steps/profile.png',
			titleKey: 'customer.steps.step2.title',
			descriptionKey: 'customer.steps.step2.description',
		},
		{
			image: '/customer_steps/negotiation.png',
			titleKey: 'customer.steps.step3.title',
			descriptionKey: 'customer.steps.step3.description',
		},
		{
			image: '/customer_steps/ongoing.png',
			titleKey: 'customer.steps.step4.title',
			descriptionKey: 'customer.steps.step4.description',
		},
		{
			image: '/customer_steps/wallet.png',
			titleKey: 'customer.steps.step5.title',
			descriptionKey: 'customer.steps.step5.description',
		},
	];
			...
			<div className="flex flex-col md:flex-row gap-8 items-center">
				...
				<div className="w-full flex-1 lg:w-1/2 flex flex-col justify-center min-h-80 space-y-5">
					...
					<div className="flex items-center justify-between mt-6">
						...
						>
							{t('customer.steps.navigation.previous')}
						</button>
						...
						>
							{t('customer.steps.navigation.next')}
						</button>
					</div>
